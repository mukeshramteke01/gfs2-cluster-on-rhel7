...
=============================================
[root@node1 ~]# pcs cluster setup --name mycluster node1.linjb.com node2.linjb.com node3.linjb.com
...
#InitiatorName=iqn.1994-05.com.redhat:b324916f554a
...
# mkfs.gfs2 -p lock_dlm -t mycluster:gfs2 -j 2 /dev/vg_cluster/lv_cluster
...
/dev/mapper/rhel-root             xfs       6.7G  1.3G  5.4G  19% /
devtmpfs                          devtmpfs  486M     0  486M   0% /dev
tmpfs                             tmpfs     497M   61M  437M  13% /dev/shm
tmpfs                             tmpfs     497M  6.7M  490M   2% /run
tmpfs                             tmpfs     497M     0  497M   0% /sys/fs/cgroup
/dev/sda1                         xfs       509M  119M  390M  24% /boot
...
/dev/mapper/rhel-root             xfs       6.7G  1.3G  5.4G  19% /
devtmpfs                          devtmpfs  486M     0  486M   0% /dev
tmpfs                             tmpfs     497M   80M  418M  16% /dev/shm
tmpfs                             tmpfs     497M  6.7M  490M   2% /run
tmpfs                             tmpfs     497M     0  497M   0% /sys/fs/cgroup
/dev/sda1                         xfs       509M  119M  390M  24% /boot
tmpfs                             tmpfs     100M     0  100M   0% /run/user/0
...
[root@node1 ~]# df -hT
Filesystem                        Type      Size  Used Avail Use% Mounted on
/dev/mapper/rhel-root             xfs       6.7G  1.3G  5.4G  20% /
devtmpfs                          devtmpfs  486M     0  486M   0% /dev
tmpfs                             tmpfs     497M   61M  437M  13% /dev/shm
tmpfs                             tmpfs     497M  6.8M  490M   2% /run
tmpfs                             tmpfs     497M     0  497M   0% /sys/fs/cgroup
/dev/sda1                         xfs       509M  119M  390M  24% /boot
tmpfs                             tmpfs     100M     0  100M   0% /run/user/0
